...
try:
    ...
    # Confirmar ejecución
    conn.commit()
    print('Stored procedure SP_Carga_Int_Dim_Producto ejecutado con éxito.')

except pyodbc.Error as e:
    print(f'Error al conectar o ejecutar el stored procedure SP_Carga_Int_Dim_Producto: {e}')
