...
try:
    ...
    # Confirmar ejecución
    conn.commit()
    print('Stored procedure SP_Carga_Int_Fact_Ventas ejecutado con éxito.')

except pyodbc.Error as e:
    print(f'Error al conectar o ejecutar el stored procedure SP_Carga_Int_Fact_Ventas: {e}')
